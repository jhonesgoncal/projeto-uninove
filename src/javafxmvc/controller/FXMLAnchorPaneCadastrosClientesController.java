...
public class FXMLAnchorPaneCadastrosClientesController implements Initializable {
    ...
    private static class FXMLAnchorPaneCadastrosClientesDialogController {

        public FXMLAnchorPaneCadastrosClientesDialogController() {
        }
        ...
        private boolean isButtonConfirmarClicked() {
            throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
        }
    }
